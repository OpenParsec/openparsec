/*
 * PARSEC HEADER: net_pckt_peer.h
 */

#ifndef _NET_PCKT_PEER_H_
#define _NET_PCKT_PEER_H_

// net_pckt_peer.c implements the following functions
// ---------------------------------------------
...
//  int		NETs_HandleInPacket					( const NetPacketExternal* ext_gamepacket, const int ext_pktlen, NetPacket* int_gamepacket );
//  int		NETs_HandleInPacket_DEMO			( const NetPacketExternal* ext_gamepacket, NetPacket* int_gamepacket, size_t& psize );
